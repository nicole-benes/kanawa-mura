...
// Source for most of this: https://github.com/box/bart/blob/master/src/Bart/EscapeColors.php
...
/**
	...
	public static function fg_color($color, $string)
	{
		...
		{
			throw new \Exception("Foreground color ($color) is not defined");
		}
	...
	public static function __callStatic($color, $arguments)
	{
     ...
     /*
      * Function to output a string with colors
      * @param array $string A collection of [ 'text', 'color' ] items which will be concatenate into a string
      */
     public static function outputString( $string ) {
          ...
          foreach( $string as $part ) {
               ...
               if( !array_key_exists( 'color', $part ) || strlen( $part[ 'color' ] ) == 0 ) {

                    $part[ 'color' ] = 'neutral';
               }

               $output .= self::fg_color( $part[ 'color' ], $part[ 'string' ] ); 
          }
